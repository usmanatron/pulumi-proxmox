...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		P:           p,
		Name:        "pve",
		Description: "A Pulumi package for creating and managing pve cloud resources.",
		Keywords:    []string{"pulumi", "pve"},
		License:     "Apache-2.0",
		Homepage:    "https://pulumi.io",
		Repository:  "https://github.com/usmanatron/pulumi-proxmox",
